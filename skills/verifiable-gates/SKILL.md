...
### working — 14 practices · full entries in `references/working.md`
...
- [`a-badge-is-somebody-elses-cache`](references/working.md#a-badge-is-somebody-elses-cache) — What a badge shows a reader is checked where the reader is, not at the badge's own source
